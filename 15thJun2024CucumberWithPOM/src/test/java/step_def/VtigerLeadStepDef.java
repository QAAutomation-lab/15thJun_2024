	...
	WebDriver driver;
	 @Given("^user already in login page$")
	    ...
	    public void validateNewlyCreatedLeadDeletion(String firstName) {
	    	...
	    	System.out.println("****************"+getVtigerLeadsPage.leadSearchResultAfterDeletion()+"**************");
	    	//Assert.assertEquals(getVtigerLeadsPage.leadSearchResultAfterDeletion(),"No Leads Found. Create or Import Leads");
	    	Assert.assertEquals(getVtigerLeadsPage.leadSearchResultAfterDeletion(),"ningún Pre-Contactos encontrado. Crear o Importar Pre-Contactos");
	    }
}
