...
public class OrangeHrmPIM_Step extends SeleniumUtility{
	...
	public void user_is_on_ornage_hrm_login_page() {
		driver=setUp("chrome", "https://opensource-demo.orangehrmlive.com/auth/login");
	...
	@When("^Fill employee details as (.+),(.+) and (.+)$")
	public void fill_employee_details_as_shailesh_kumar_and(String fname, String lname, String id) {
	    getAddEmployeePage.createEmployee(fname, lname, Integer.parseInt(id));
	...
	@When("Enter created Employee ID in Employee Id (.+) input field")
	public void enter_created_employee_id_in_employee_id_input_field(String id) {
		getPimHomePage.searchCreatedEmployee(Integer.parseInt(id));
